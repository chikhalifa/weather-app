...
function App() {
  ...
  const getWeatherBackground = () => {
    ...
    return isDark
      ...
      : 'from-atmosphere-50 via-white to-sunset-50';
  };
  ...
  return (
    <div className={`min-h-screen relative overflow-hidden transition-all duration-1000 bg-gradient-to-br ${getWeatherBackground()}`}>
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-sunset-400/20 dark:bg-atmosphere-500/10 rounded-full blur-3xl animate-drift"></div>
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-atmosphere-400/20 dark:bg-storm-700/20 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute top-1/2 left-1/2 w-[400px] h-[400px] bg-sunset-300/10 dark:bg-atmosphere-600/10 rounded-full blur-3xl animate-float-slow"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-8 pb-20 pt-32 relative z-10">
        ...
        <header className="max-w-5xl mx-auto mb-16 text-center">
          ...
          <div className="relative inline-block mb-8 group cursor-pointer">
            <div className="absolute inset-0 bg-gradient-radial from-sunset-400/40 to-transparent blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 animate-pulse-slow"></div>
          ...
          <h1 className="font-display text-6xl md:text-8xl lg:text-9xl font-black mb-6 leading-none tracking-tight transform hover:scale-105 transition-transform duration-500 cursor-pointer">
            <span className="inline-block bg-gradient-to-br from-white via-blue-200 to-cyan-300 dark:from-white dark:via-blue-100 dark:to-atmosphere-200 bg-clip-text text-transparent animate-shimmer bg-[length:200%_100%] drop-shadow-2xl">
              Weather
            </span>
            <br />
            <span className="inline-block text-blue-100 dark:text-storm-300 opacity-80 font-sans font-light text-5xl md:text-7xl lg:text-8xl mt-2 hover:opacity-100 transition-opacity">
              Forecast
            </span>
          </h1>
        ...
        <main className="max-w-7xl mx-auto">
            ...
            <div className="glass-effect-light p-16 rounded-[3rem] text-center max-w-2xl mx-auto transform hover:scale-[1.02] transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="relative">
                <div className="relative inline-block mb-8">
                  <CloudRain size={96} className="text-atmosphere-500 dark:text-atmosphere-400 opacity-60 group-hover:opacity-100 transition-all duration-500 animate-float" strokeWidth={1.5} />
                  <div className="absolute -top-4 -right-4 w-8 h-8 bg-yellow-400 rounded-full animate-pulse-slow"></div>
                </div>

                <p className="text-3xl md:text-4xl font-display font-bold text-white/90 leading-relaxed mb-4">
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center h-96 gap-6">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-radial from-sunset-400/30 to-transparent blur-3xl animate-pulse"></div>
                <Loader2 className="animate-spin text-white relative" size={80} strokeWidth={1.5} />
              </div>
              <p className="text-xl font-display font-semibold text-white/80 animate-pulse">
          ...
          {/* Error State */}
          {error && (
            <div className="glass-effect-light border-red-400/50 p-12 rounded-3xl text-center max-w-lg mx-auto transform hover:scale-105 transition-transform duration-300">
              <p className="text-2xl font-display font-bold text-red-200 mb-2">
